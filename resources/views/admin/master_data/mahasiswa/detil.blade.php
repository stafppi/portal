    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="tab-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('mahasiswa.edit', $mahasiswa->id)}}">
                    @csrf
                    <div class="form-group row">
                    <label for="inputName" class="col-sm-3 col-form-label">NIM</label>
                    <div class="col-sm-9">
                        <input type="text" value="{{ $mahasiswa->nim }}" disabled="" class="form-control" id="nim" placeholder="NIM">
                    </div>
                    </div>
                    <div class="form-group row">
