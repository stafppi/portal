    ...
    <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <a href="{{route('mahasiswa.view')}}" class="btn btn-warning"><i class="fa fa-caret-left"> Kembali</i></a>
                  ...
                  <tbody>
                    ...
                    <td>{{ $i++ }}</td>
                        ...
                        <td>
                          ...
                          <a title="Restore" href="{{ route('mahasiswa.back', $mahasiswa->id) }}" class="btn btn-sm btn-primary" id="restore"><i class="fa fa-random"></i></a>
