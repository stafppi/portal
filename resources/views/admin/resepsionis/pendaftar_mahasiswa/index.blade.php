...
<div class="content">
    ...
    <div class="row">
            ...
            <div class="card">
              ...
              <a href="{{route('mahasiswa.restore')}}"><i class="fa fa-trash">Trash</i></a>
                  ...
                  @php($i = 1)
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a title="Hapus" href="{{ route('mahasiswa.delete.soft', $mahasiswa->id) }}" class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    @endif
                    @endforeach
            ...
            <div class="modal-body">
              <div class="col-md-12">
                <!-- general form elements -->
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="{{route('mahasiswa.add')}}" method="POST">
                    @csrf
                    <div class="card-body">
