    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="tab-content">
                ...
                <!-- /.post -->
                <a href="{{ route('karyawan.view') }}" class="btn btn-warning">Kembali</a>
                </div>
                <!-- /.tab-pane -->
                <div class="tab-pane" id="timeline">
                <form class="form-horizontal" method="post" action="{{ route('karyawan.edit', $karyawan->id) }}">
                    @csrf
                    <div class="form-group row">
                    <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="nama" value="{{ $karyawan->nama }}" class="form-control" id="inputName" placeholder="Name">
                    </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="tempat_lahir" value="{{ $karyawan->tempat_lahir }}" class="form-control" id="tempat_lahir" placeholder="ex : Bandung">
                    </div>
                    </div>
                    <div class="form-group row">
                    <label for="tanggal_lahir" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                    <div class="col-sm-10">
                        <input type="date" name="tanggal_lahir" value="{{ $karyawan->tanggal_lahir }}" class="form-control" id="tanggal_lahir">
                    </div>
                    </div>
                    <div class="form-group row">
                    <label for="agama" class="col-sm-2 col-form-label">Agama</label>
                    <div class="col-sm-10">
                        <input type="text" name="agama" value="{{ $karyawan->agama }}" class="form-control" id="agama">
                    </div>
                    </div>
                    <div class="form-group row">
                    <label for="no_telepon" class="col-sm-2 col-form-label">Telp/WhatsApp</label>
                    <div class="col-sm-10">
                        <input type="text" name="no_telepon" value="{{ $karyawan->no_telepon }}" class="form-control" id="no_telepon">
                    </div>
                    </div>
                    <div class="form-group row">
